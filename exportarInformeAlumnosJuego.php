<?php
    ...
    AND juega_colecciones.NombreColeccion ='$coleccion' AND juega_colecciones.EstadoColeccion ='juego'
    ...
    header("Content-Disposition: attachment;filename=$nombreCorrecto Juego.xlsx");
