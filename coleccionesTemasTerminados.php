<?php
    if (!isset($_SESSION)){
        session_start();
        $page = $_SESSION["page"];
        $_SESSION["page"] = "coleccionesTemaTerminados.php";
        ;
    }
	...
	function mostrarColeccionesTerminadas() {
                   ...
                   <div class="single-product" align="center">
						...
						<div class="product-f-image">';
							...
							<div class='product-hover'>		
                                <a href='' class='add-to-cart-link'><i class='fa fa-download' aria-hidden='true'></i> Exportar</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <h2><strong>Colecciones terminadas de <?php echo "$tema";?> </strong></h2>
                    </div>
                </div>
            </div>
        </div>
