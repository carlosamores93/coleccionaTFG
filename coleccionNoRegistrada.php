<?php
    ...
    if (!isset($_SESSION)){
        session_start();
        $page = $_SESSION["page"];
        $_SESSION["page"] = "coleccionNoRegistrada.php";
        //echo $_SESSION["super"];
    }
						...
						<div class="product-content-right">
                            ...
                            <div id="customer_details" class="col2-set">
								<div class="col-1">
                                    ...
                                    <a href="crearColeccion.php">

                                        <h2 class="section-title"><span class="cart-amunt">Colección NO registrada</span></h2>

                                    </a>

                                    
                                    <h3 class="section-title"><span class="cart-amunt">Ya existe una colección con ese nombre.</span></h3>    
