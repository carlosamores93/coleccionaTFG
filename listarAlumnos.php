<?php
    if (!isset($_SESSION)){
        session_start();
        $page = $_SESSION["page"];
        $_SESSION["page"] = "listarAlumnos.php";
        //echo $_SESSION["super"];
    }
    ...
    function mostrarAlumnos() {
        ...
        if($search != ""){
            ...
            (SELECT UsuarioAlumno FROM mis_alumnos 
                        WHERE UsuarioProfesor ='$profe')
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">';
                            echo "<a href='pasarAlumno.php?usuario=$usuario'> ";
                ...
                echo '        
                        ...
                        if($puedeJugar == "no"){
                                ...
                                echo "
                                <a class='add_to_cart_button' href='activarAlumno.php?usuario=$usuario&lista=si' >ALTA</a>
                                ";

                        }else{
                            echo "
                            <a class='add_to_cart_button' href='desactivarAlumno.php?usuario=$usuario&lista=si' >BAJA</a>
                            ";
                        }
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="listarAlumnos.php">Alumnos</a></li>
