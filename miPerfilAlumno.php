<?php
    ...
    if (!isset($_SESSION)){
        session_start();
        $page = $_SESSION["page"];
        $_SESSION["page"] = "miPerfilAlumno.php";
        //echo $_SESSION["super"];
    }
...
<html lang="en">
  ...
  <body>
    ...
    mysqli_query($link, "SET NAMES 'utf8'");
        ...
        $query="SELECT NombreAlumno, ApellidosAlumno, FotoAlumno, CorreoAlumno, ColeccionesJuego, ColeccionesFin, 
			NumeroFichas, PreguntasAcertadas, PreguntasFalladas FROM alumnos
                                    ...
                                    <div role="tabpanel">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="detalles">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <h3>Fichas totales conseguidas</h3>
                                                            <font color="#5a88ca">
                                                                <label>
                                                                    <h4>
                                                                        <strong>
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="modificar">
												...
												<form action="modificarAlumno.php" method="post" enctype="multipart/form-data" 
                                                class="checkout" name="checkout"  onsubmit="return validarPerfil()" > 
													<div id="customer_details" class="col2-set">
														<div class="col-1">

															<label class="" >Nombre </label>
															<input type="text" value="<?php echo "$nombre";?>" placeholder="Nombre" id="billing_first_name" name="billing_first_name" class="input-text " required>

															<label class="" >Apellidos </label>
															<input type="text" value="<?php echo "$apellidos";?>" placeholder="Apellidos" id="billing_last_name" name="billing_last_name" class="input-text " required>
															
															<label class="" >Email</label>
															<input type="email" value="<?php echo "$correo";?>" placeholder="Correo electrónico" id="billing_email" name="billing_email" class="input-text " required>
															<br>
											...
											<div role="tabpanel" class="tab-pane fade" id="eliminar" align="center">
                                                <h2>¿Estás seguro que quieres eliminar tu perfil?</h2>
												 <form action="eliminarAlumno.php" 
