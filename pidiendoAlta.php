<?php
    if (!isset($_SESSION)){
        session_start();
        $page = $_SESSION["page"];
        $_SESSION["page"] = "pidiendoAlta.php";
        //echo $_SESSION["super"];
    }
						...
						<div class="product-content-right">
                            ...
                            <div id="customer_details" class="col2-set">
								<div class="col-3">
                                    ...
                                    <br>
                                    <br>
                                    <a href="coleccionesNuevas.php">

                                        <h2 class="section-title"><span class="cart-amunt">BIENVENIDO A COLECCIONA</span></h2>
										<h2 class="section-title"><span class="cart-amunt">Acabas de pedirle al profesor jugar sus colecciones, 
																							se paciente, pronto te dará de ALTA.</span></h2>
                                    </a>
                                    <br>
                                    <br>
                                    <br>
