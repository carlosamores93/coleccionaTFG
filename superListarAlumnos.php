<?php
    ...
    if (!isset($_SESSION)){
        session_start();
        $page = $_SESSION["page"];
        $_SESSION["page"] = "superListarAlumnos.php";
        //echo $_SESSION["super"];
    }
    ...
    function mostrarAlumnos() {
        ...
        if($search != ""){
            $query="SELECT UsuarioAlumno, NombreAlumno, ApellidosAlumno, FotoAlumno FROM alumnos
            WHERE NombreAlumno LIKE '%$search%' OR ApellidosAlumno LIKE '%$search%' OR UsuarioAlumno LIKE '%$search%' ORDER BY IdAlumno ASC";
        }else{
            if($filtro == "Nombre"){
                $query="SELECT UsuarioAlumno, NombreAlumno, ApellidosAlumno, FotoAlumno FROM alumnos
                ...
                $query="SELECT UsuarioAlumno, NombreAlumno, ApellidosAlumno, FotoAlumno FROM alumnos
                WHERE IdAlumno > 0 ORDER BY IdAlumno ASC";
            }else{
                $query="SELECT UsuarioAlumno, NombreAlumno, ApellidosAlumno, FotoAlumno FROM alumnos
                WHERE IdAlumno > 0 ORDER BY IdAlumno ASC";
            }
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">';
                            echo "<a href='superUsuarioTipo.php?usuario=$usuario&tipo=Alumno'> ";
                ...
                echo '        
                        <div class="product-option-shop">';
                            ...
                            href='superUsuarioTipo.php?usuario=$usuario&tipo=Alumno'>DETALLES</a> ";
                            echo "<a class='add_to_cart_button' href='eliminarUsuario.php?usuario=$usuario&tipo=Alumno' 
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active" ><a href="superListarAlumnos.php">Alumnos</a></li>
    ...
    <div class="single-product-area">
        ...
        <div class="container">
            ...
            <div class="single-sidebar2">
                <form action="superListarAlumnos.php" method="post" enctype="multipart/form-data" >
