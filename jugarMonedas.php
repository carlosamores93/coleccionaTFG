<?php
    ...
    if (!isset($_SESSION)){
        ...
        $page = $_SESSION["page"];
		 ...
		 $_SESSION["page"] = "jugarMonedas.php";
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $query="SELECT *
    FROM preguntas WHERE NombreColeccion = '$nombreColeccion' AND DificultadPregunta = 'Fácil'
...
<script language="javascript"> 
    ...
    var url="http://www.colecciona.hol.es/recargarPregunta.php?idPregunta=<?php echo "$idPregunta";?>";
    //var url="http://piloto.fis.ucm.es/colecciona/recargarPregunta.php?idPregunta=<?php echo "$idPregunta";?>";
    function timer(){  
								...
								<tr class="cart_item">
									...
									<td class="product-thumbnailmensaje">
										<img width="105" height="105" alt="poster_1_up" 
											class="shop_thumbnail" title="Reloj" type="image" src="img/vidas.png">
									</td>
									<td class="product-thumbnailmensaje">
                                        <label>
                                            <?php echo "$vidas";?>
									...
									<td class="product-thumbnailmensaje">
										<img width="105" height="105" alt="poster_1_up" 
											class="shop_thumbnail" title="Reloj" type="image" src="img/moneditas.png">
									</td>
									<td class="product-thumbnailmensaje">
                                        <label>
                                            <?php echo "$monedas";?>
									...
									<td class="product-thumbnailmensaje">
										<a href="#"><img width="105" height="105" alt="poster_1_up" 
											class="shop_thumbnail" title="Reloj" type="image" src="img/relojarena.png"></a>
									</td>
                            ...
                            <div class="col-sm-6">
                                <div class="product-images">
                                    <div align ="justify" class="product-main-test">
										...
										<form action="comprobarRespuestaMonedas.php?idPregunta=<?php echo "$idPregunta";?>" 
                                        ...
                                        <ul class="product-tab" role="tablist">
                                            <li role="presentation" class="active">
												<a aria-controls="home" role="tab" data-toggle="tab">
													MONEDAS A GANAR: <strong><?php echo "$monedasAGanar";?></strong>
