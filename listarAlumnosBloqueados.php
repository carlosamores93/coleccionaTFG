<?php
    if (!isset($_SESSION)){
        session_start();
        $page = $_SESSION["page"];
        $_SESSION["page"] = "listarAlumnosBloqueados.php";
        //echo $_SESSION["super"];
    }
    ...
    function mostrarAlumnos() {
        ...
        if($search != ""){
            ...
            (SELECT UsuarioAlumno FROM juega_colecciones 
                        WHERE NombreColeccion ='$nombreColeccion' AND EstadoColeccion ='bloqueada')
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        ...
                        echo "
                             <a class='add_to_cart_button' href='desbloquearAlumno.php?usuario=$usuario&coleccion=$nombreColeccion' >DESBLOQUEAR</a>
                             ";
