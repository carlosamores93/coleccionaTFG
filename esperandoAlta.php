<?php
    if (!isset($_SESSION)){
        session_start();
        $page = $_SESSION["page"];
        $_SESSION["page"] = "esperandoAlta.php";
        //echo $_SESSION["super"];
    }
                            ...
                            <div id="customer_details" class="col2-set">
								<div class="col-3">
                                    ...
                                    <a href="coleccionesNuevas.php">
                                        ...
                                        <h2 class="section-title"><span class="cart-amunt">TEN PACIENCIA</span></h2>
										<h2 class="section-title"><span class="cart-amunt">El profesor todavía no te ha dado de alta en sus colecciones</span></h2>
                                    </a>
                                    <br>
                                    <br>
                                    <br>
