<script language="JavaScript">
	...
	function validarColeccionModificada(){
	
		var nombreColeccionCorrecto = document.getElementById('billing_nombre_coleccion').value;
		...
		var claveColeccion = document.getElementById('billing_clave').value;
