<?php
    ...
    if (!isset($_SESSION)){
        session_start();
        $page = $_SESSION["page"];
        $_SESSION["page"] = "coleccionesTerminadas.php";
        //echo $_SESSION["super"];
    }
	...
	function mostrarColeccionesTermindas() {
		...
		AND juega_colecciones.UsuarioAlumno = '$yoAlumno' AND  juega_colecciones.EstadoColeccion = 'terminada'
                   ...
                   <div class="single-product" align="center">
						...
						<div class="product-f-image">';
							...
							<div class='product-hover'>		
                                <a href='pasarColeccionDescargar.php?nombreColeccion=$nombreColeccion' target='_blank' class='add-to-cart-link'><i class='fa fa-download' aria-hidden='true'></i> Exportar</a>
								<a href='pasarColeccionTerminada.php?nombreColeccion=$nombreColeccion' class='view-details-link'><i class='fa fa-eye' aria-hidden='true'></i> Ver colección</a>
							</div>
						</div>";	
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="coleccionesTerminadas.php">Terminadas</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <h2><strong>Colecciones terminadas</strong></h2>
                    </div>
                </div>
            </div>
        </div>
