<?php
    if (!isset($_SESSION)){
        session_start();
        $page = $_SESSION["page"];
        $_SESSION["page"] = "listarAlumnosTerminada.php";
        //echo $_SESSION["super"];
    }
    ...
    function mostrarAlumnos() {
        ...
        if($search != ""){
            ...
            (SELECT UsuarioAlumno FROM juega_colecciones 
                        WHERE NombreColeccion ='$nombreColeccion' AND EstadoColeccion ='terminada')
    ...
    <div class="single-product-area">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <a href="exportarInformeAlumnosTerminado.php" target="_blank">
