<?php
    if (!isset($_SESSION)){
        session_start();
        $page = $_SESSION["page"];
        $_SESSION["page"] = "coleccionesNuevas.php";
        //echo $_SESSION["super"];
    }
	...
	function mostrarColeccionesNuevas() {
        ...
        */
        ...
        // Aqui  mostrar los colecciones nuevas
        if($search != ""){
            $query="SELECT NombreColeccion, UsuarioProfesor, TemaColeccion,
            NombreColeccionCorrecto, FotoColeccion 
            FROM colecciones 
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="coleccionesNuevas.php">Nuevas</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <h2><strong>Colecciones nuevas</strong></h2>
                    </div>
                </div>
            </div>
        </div>
