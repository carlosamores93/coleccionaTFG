<?php
    ...
    if (!isset($_SESSION)){
        session_start();
        $page = $_SESSION["page"];
        $_SESSION["page"] = "miPerfilSuper.php";
        //echo $_SESSION["super"];
    }
...
<?php
    ...
    $query="SELECT NombreSuper, ApellidosSuper, FotoSuper FROM superadmin
    WHERE UsuarioSuper = '$usuario' ";
    if ($result = mysqli_query($link, $query)) {
        // fetch associative array 
        while ($row = mysqli_fetch_assoc($result)) {
            $nombre = $row["NombreSuper"];
            $apellidos = $row["ApellidosSuper"];
            $foto = $row["FotoSuper"];
            if($foto == ""){
                $foto="img/super.png";
            }
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="detalles">
												...
												<div class="product-inner-price">
													<h3>Usuario</h3>
													<font color="#5a88ca"><label><h4><strong>
                                                    <?php echo "$usuario";?>
                                                    </strong></h4></label></font>
													<h3>Nombre</h3>
													<font color="#5a88ca"><label><h4><strong>
                                                    <?php echo "$nombre";?>
                                                    </strong></h4></label></font>
													<h3>Apellidos</h3>
													<font color="#5a88ca"><label><h4><strong><?php echo "$apellidos";?></strong></h4></label></font>
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="modificar">
												...
												<form action="modificarSuper.php" method="post" enctype="multipart/form-data" 
                                                class="checkout" name="checkout" onsubmit="return validarSuper()">
													<div id="customer_details" class="col2-set">
														<div class="col-1">	

                                                            <label class="" >Usuario </label>
                                                            <input type="text" value="<?php echo "$usuario";?>" 
                                                            placeholder="Usuario" id="billing_usuario" 
                                                            name="billing_usuario" 
                                                            maxlength="20" 
                                                            ...
                                                            id="billing_pass1" name="billing_pass1" 
                                                            maxlength="60" class="input-text " required>
															<br>
														   
															<label class="" >Repite contraseña </label>
															<input type="password" value="" placeholder="Contraseña" 
                                                            id="billing_pass2" name="billing_pass2" 
                                                            maxlength="60" class="input-text " required>
															<br>
